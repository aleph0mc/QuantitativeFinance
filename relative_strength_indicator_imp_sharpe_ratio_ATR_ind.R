...
xts_atr <-na.omit(ATR(HLC(xtsHistData), n = 14))
summary(xts_atr)
# xts to vector
vect_atr <- coredata(xts_atr[, 'atr'])
# last element to get yesterday's ATR value
# extract the value and assign to variable
atr_asat_yester <- tail(vect_atr, n = 1)
print(atr_asat_yester[1])
